<?php
require_once dirname(__FILE__) . "/layout/frontend/header.php";


require_once dirname(__FILE__) . "/pages/home/slider.php"
    ...
    <div class="col-md-8">
     <div class="kf_edu2_tab_wrap">
      ...
      <ul class="nav nav-tabs" role="tablist">
       <li role="presentation" class="active"><a href="#all" aria-controls="all" role="tab" data-toggle="tab">All</a>
       </li>
       <li role="presentation"><a href="#accounting" aria-controls="accounting" role="tab"
         data-toggle="tab">Accounting</a></li>
       <li role="presentation"><a href="#economics" aria-controls="economics" role="tab" data-toggle="tab">Economics</a>
       </li>
       <li role="presentation"><a href="#finance" aria-controls="finance" role="tab" data-toggle="tab">Finance</a></li>
       <li role="presentation"><a href="#technologies" aria-controls="technologies" role="tab"
         data-toggle="tab">Technologies</a></li>
       <li role="presentation"><a href="#management" aria-controls="management" role="tab" data-toggle="tab">Management
        </a></li>
         ...
         <div class="col-md-4">
          <div class="edu2_cur_wrap">
           ...
           <div class="edu2_cur_des">
            ...
            <p>If you want to build a successful business online, watch the promo video to see why 13,000+ students are
             using this online entrepreneurship course to learn.</p>
           </div>
         ...
         <div class="col-md-4">
          <div class="edu2_cur_wrap">
           ...
           <div class="edu2_cur_des">
            ...
            <p>Personal time management skills are essential for professional & personal success in any area of life.
             Those able to successfully implement time management strategies</p>
           </div>
           <div class="edu2_cur_des_ft">
            <figure>
         ...
         <div class="col-md-4">
          <div class="edu2_cur_wrap">
           ...
           <div class="edu2_cur_des">
            ...
            <p>Welcome to Logo Design fundamentals of building a great brand Logo. Our course teacher Lauren, walks you
             through his process of logo design.</p>
           </div>
           <div class="edu2_cur_des_ft">
            <figure>
...
<?php
require_once dirname(__FILE__) . "/layout/frontend/footer.php"
